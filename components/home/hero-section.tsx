            ...
            <main className="overflow-hidden">
                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants as any}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">AI-Native Form Builder</span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-6xl lg:mt-16 xl:text-[5.25rem]">
                                       Forms that feel like conversations
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Create beautiful, AI-powered forms in seconds. Get 60% more completions with our conversational interface that people actually enjoy using.
                                    </p>
                                </AnimatedGroup>
                        ...
                        <p className="text-sm text-muted-foreground text-center mt-4">No credit card required • 3 forms free forever</p>
