...
export function ExamplesSection() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Screen candidates intelligently with adaptive questions. Reduce time-to-hire by 40%.",
      icon: <Zap />,
    },
    {
      title: "Market Research",
      description:
        "Conduct in-depth research with AI that asks follow-up questions. Get insights traditional surveys miss.",
      icon: <BarChart3 />,
    },
    {
