        ...
        <AnimatedContainer>
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              The first truly AI-native form platform designed for the modern
              web
            </p>
          </div>
        </AnimatedContainer>
          ...
          <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
            <Card className="group shadow-black-950/5 hover:shadow hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm">
                  {" "}
                  Just describe what you need. Our AI generates complete forms
                  with smart logic, validation, and beautiful design in seconds.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group shadow-black-950/5 hover:shadow hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm">
                  One question at a time, just like chatting. Voice input,
                  natural language, and AI that understands context.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group shadow-black-950/5 hover:shadow hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm">
                  AI-powered insights, sentiment analysis, and actionable
                  recommendations to improve your forms.
                </p>
              </CardContent>
            </Card>
          </div>
