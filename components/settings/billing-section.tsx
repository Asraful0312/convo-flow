    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-6 rounded-lg border-2 border-[#F56A4D] bg-[#F56A4D]/5">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                {billingInfo.tier !== "free" && (
                  <Badge className="bg-[#F56A4D] text-white">Current</Badge>
                )}
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                  <div
                    className="h-full bg-linear-to-r from-[#F56A4D] to-[#f97316]"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            You can manage your payment method, view invoices, and update your
            billing information in the Stripe Billing Portal.
          </p>
          <Button
            onClick={handleManageSubscription}
            variant="outline"
